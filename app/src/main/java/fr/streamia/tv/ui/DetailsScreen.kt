...
private fun DetailLine(label: String, value: String?) {
    ...
    Row(Modifier.fillMaxWidth(), verticalAlignment = Alignment.Top) {
        Text(label, color = MutedInk, fontSize = TypeLabel, fontWeight = FontWeight.Bold, modifier = Modifier.width(150.dp))
        Text(value, color = Ink, fontSize = TypeLabel, lineHeight = 20.sp, modifier = Modifier.weight(1f))
    }
}
